...
public class MedicalServiceServiceImpl implements MedicalServiceServiceInterface {
    ...
    public MedicalService findById(Long serviceId) {
        ...
        return medicalServiceRepository.findByIdAndActive(serviceId).orElseThrow(() -> new EntityNotFoundException("Medical service not found with ID: " + serviceId));
    }
    ...
    private void validateServiceBelongsToClinic(MedicalService service, Long clinicId) throws AccessDeniedException {
