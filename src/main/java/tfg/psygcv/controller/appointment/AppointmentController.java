...
public class AppointmentController extends BaseController {
    ...
    @GetMapping("/new")
    public String showNewAppointmentForm(@RequestParam("clinicId") Long clinicId,
                                         Model model,
    ...
    @PostMapping("/new")
    public String createAppointment(@RequestParam("clinicId") Long clinicId,
    ...
    @GetMapping("/{id}")
    public String showAppointmentDetails(@PathVariable Long id,
                                         Model model,
                                         Authentication authentication) {
    ...
    @GetMapping("/schedule")
    public String showScheduleForm(@RequestParam(required = false) Long clientId,
                                   Model model,
                                   Authentication authentication) {
        User receptionist = getCurrentUser(authentication);
        VeterinaryClinic clinic = veterinaryClinicService.findByReceptionistId(receptionist.getId());
