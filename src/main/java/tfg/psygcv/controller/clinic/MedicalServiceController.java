...
public class MedicalServiceController extends BaseController {
    ...
    @PostMapping("/new")
    public String saveService(@Valid @ModelAttribute MedicalService medicalService,
    ...
    public String showEditForm(@PathVariable Long id,
        ...
        VeterinaryClinic clinic = veterinaryClinicService.findByVeterinarianId(veterinarian.getId());
        model.addAttribute("medicalService", medicalServiceService.findByIdAndValidateClinic(id, clinic.getId()));
        model.addAttribute("clinicId", clinic.getId());
