package tfg.psygcv.pet.controller;

import static tfg.psygcv.shared.constant.RouteConstant.REDIRECT_MY_PETS_CREATED;
import static tfg.psygcv.shared.constant.RouteConstant.REDIRECT_MY_PETS_DELETED;
import static tfg.psygcv.shared.constant.RouteConstant.REDIRECT_MY_PETS_UPDATED;
...
public class PetController extends BaseController {
  ...
  public String savePet(
    ...
    try {
      AuthenticatedUser currentUser = getAuthenticatedUser(authentication);
      petService.save(PetMapper.toCreateCommand(request, currentUser.getId()));
  ...
  public String updatePet(
    ...
    try {
      petService.update(id, PetMapper.toUpdateCommand(request));
